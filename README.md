# 16-kb CIDR Routing Rules

Этот репозиторий автоматически генерирует и обновляет подсети (CIDR) в форматах `TXT` и `SRS` для использования в **sing-box**, **v2ray**, **xray** и других инструментах обхода блокировок. Сборка происходит каждую ночь.

## 🔗 Ссылки для скачивания (Байпас блокировок GitHub)

Поскольку сам `github.com` и `raw.githubusercontent.com` могут быть заблокированы в вашем регионе, вы можете использовать следующие зеркала и прокси для загрузки:
